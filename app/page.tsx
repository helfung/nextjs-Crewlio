...
function Pill({
  ...
  tone?: "default" | "green" | "red" | "amber" | "teal";
}) {
  const colours = {
  ...
  return (
    <span className={`rounded-full px-3 py-1 text-xs font-medium ${colours[tone]}`}>
      {children}
    </span>
  );
}
...
export default function Page() {
  ...
  if (!user) {
    return (
      <main className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 via-white to-teal-50 p-4">
